...
Graph <- ggplot(data, aes(x = Model, y = AIC, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph AIC.jpg", plot = Graph)
```
...
Graph1 <- ggplot(data1, aes(x = Index, y = AIC, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log UniTD AIC.jpg", plot = Graph1)
```
...
Graph2 <- ggplot(data1, aes(x = Index, y = AIC, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log MultiTD AIC.jpg", plot = Graph2)
```
...
Graph3 <- ggplot(data1, aes(x = Index, y = AIC, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log Spline AIC.jpg", plot = Graph3)
```
...
Graph4 <- ggplot(data1, aes(x = Index, y = AIC, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log RowCol AIC.jpg", plot = Graph4)
```

```{r}
combo <- ggarrange(Graph1,Graph4,Graph3,ncol = 3,nrow = 1, common.legend = T, legend = "top") %>%  annotate_figure(top = text_grob("Spatial Model Fit with SRIs Covarietes (AIC)", color = "black", face = "bold", size = 18))
                   #labels = c("A","B","C","D"))
#combo <- annotate_figure(combo, top = text_grob("AIC from Spatial Analysis with UAS Data",
                                                #face = "bold", size = 22))

combo

ggsave(filename = "Index Effect AIC.jpg", combo, height = 5, width = 7.5 )
```

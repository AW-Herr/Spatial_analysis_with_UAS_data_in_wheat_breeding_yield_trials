...
data <- data %>% mutate(Design = str_replace_all(Design,"Augmented","ACBD"))
```
...
Graph <- ggplot(data, aes(x = Model, y = Moran.I.statistic, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
                         ...
                         position = position_dodge(0.175)) +
            scale_x_discrete(name = "Model") + 
            scale_y_continuous(name = "Moran I Statistic")

ggsave(filename = "Model Graph Moran I Statistic.jpg", plot = Graph)
```
...
Graph1 <- ggplot(data1, aes(x = Index, y = Moran.I.statistic, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log UniTD Moran I Statistic.jpg", plot = Graph1)
```
...
Graph2 <- ggplot(data1, aes(x = Index, y = Moran.I.statistic, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log MultiTD Moran I Statistic.jpg", plot = Graph2)
```
...
Graph3 <- ggplot(data1, aes(x = Index, y = Moran.I.statistic, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log Spline Moran I Statistic.jpg", plot = Graph3)
```
...
Graph4 <- ggplot(data1, aes(x = Index, y = Moran.I.statistic, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log RowCol Moran I Statistic.jpg", plot = Graph4)
```

```{r}
combo <- ggarrange(Graph1,Graph3,Graph4,ncol = 3,nrow = 1, common.legend = T, legend = "top") %>%  annotate_figure(top = text_grob("Autocorrelation of Trials with SRI Covarietes", color = "black", face = "bold", size = 18))
                   #labels = c("A","B","C","D"))
#combo <- annotate_figure(combo, top = text_grob("Moran I Statistic from Spatial Analysis with UAS Data",
                                                #face = "bold", size = 22))

combo

ggsave(filename = "Index Effect Moran I Statistic.jpg", combo, height = 5, width = 7.5 )
```

```{r}
Moran.I.1 <-  ggplot(data, aes(x = Moran.I.statistic, fill = Design)) +
                  geom_dotplot(binwidth = .027, stackgroups = T, binpositions = "all", color = NA) +
...
Moran.I.2 <- ggplot(data, aes(x = Moran.I.statistic, fill = Index)) +
                  geom_dotplot(binwidth = .028,stackgroups = TRUE, binpositions = "all")
...
combo <- ggarrange(Moran.I.1,Moran.I.3,ncol = 2,nrow = 1, common.legend = F, legend = "top", labels = c("A","B")) %>%  annotate_figure(top = text_grob("Autocorrelation of Trials (Moran I)", color = "black", face = "bold", size = 18))
                   #labels = c("A","B","C","D"))
#combo <- annotate_figure(combo, top = text_grob("Moran I Statistic from Spatial Analysis with UAS Data",
                                                #face = "bold", size = 22))
...
ggsave(filename = "Moran I Statistic Dis.jpg", combo, height = 5, width = 7.5 )
```

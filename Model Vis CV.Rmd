...
Graph <- ggplot(data, aes(x = Model, y = CV, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph CV.jpg", plot = Graph)
```
...
Graph1 <- ggplot(data1, aes(x = Index, y = CV, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log UniTD CV.jpg", plot = Graph1)
```
...
Graph2 <- ggplot(data1, aes(x = Index, y = CV, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log MultiTD CV.jpg", plot = Graph2)
```
...
Graph3 <- ggplot(data1, aes(x = Index, y = CV, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log Spline CV.jpg", plot = Graph3)
```
...
Graph4 <- ggplot(data1, aes(x = Index, y = CV, fill = Design)) +
            introdataviz::geom_split_violin(alpha = 0.4, trim = F) +
            geom_boxplot(width = 0.2, alpha = 0.6, fatten = NULL, show.legend = F) +
            stat_summary(fun.data = "mean_se",
                         geom = "pointrange",
...
ggsave(filename = "Model Graph Log RowCol CV.jpg", plot = Graph4)
```

```{r}
combo <- ggarrange(Graph1,Graph4,Graph3,ncol = 3,nrow = 1, common.legend = T, legend = "top") %>%  annotate_figure(top = text_grob("Variability of Adjusted Trials with SRI Covarietes (CV)", color = "black", face = "bold", size = 18))
                   #labels = c("A","B","C","D"))
#combo <- annotate_figure(combo, top = text_grob("CV from Spatial Analysis with UAS Data",
                                                #face = "bold", size = 22))

combo

ggsave(filename = "Index Effect CV.jpg", combo, height = 5, width = 7.5 )
```
